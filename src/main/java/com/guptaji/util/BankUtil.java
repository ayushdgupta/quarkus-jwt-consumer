...
public class BankUtil {
  ...
  static {
    bankEntities.add(
        new BankEntity(1, "HDFC", "HDFC001", "Agra", List.of("Savings", "Current", "Salary")));
    bankEntities.add(
        new BankEntity(2, "SBI", "SBI001", "Agra", List.of("Savings", "Loan", "Salary")));
    bankEntities.add(
        new BankEntity(3, "Indian", "Indian001", "Agra", List.of("Current", "Salary")));
    bankEntities.add(
        new BankEntity(4, "ICICI", "ICICI001", "Agra", List.of("Savings", "Current", "Salary")));
  }
  ...
  public static BankEntity findBankById(int id) {
    Optional<BankEntity> bankOptionalObject =
        bankEntities.stream().filter(temp -> temp.getId() == id).findFirst();
